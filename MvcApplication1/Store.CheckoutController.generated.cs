...
namespace Llprk.Web.UI.Areas.Store.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CheckoutController : Llprk.Web.UI.Areas.Store.Controllers.CheckoutController
    {
        ...
        [NonAction]
        partial void SuccessOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid id);

        [NonAction]
        public override System.Web.Mvc.ActionResult Success(System.Guid id)
        {
