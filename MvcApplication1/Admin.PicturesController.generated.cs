...
namespace Llprk.Web.UI.Areas.Admin.Controllers
{
    public partial class PicturesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PicturesController Actions { get { return MVC.Admin.Pictures; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/Admin/Views/Pictures/Create.cshtml";
            public readonly string Delete = "~/Areas/Admin/Views/Pictures/Delete.cshtml";
            public readonly string Details = "~/Areas/Admin/Views/Pictures/Details.cshtml";
            public readonly string Edit = "~/Areas/Admin/Views/Pictures/Edit.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/Pictures/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PicturesController : Llprk.Web.UI.Areas.Admin.Controllers.PicturesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Collections.Generic.IEnumerable<System.Web.HttpPostedFileBase> files);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(System.Collections.Generic.IEnumerable<System.Web.HttpPostedFileBase> files)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "files", files);
            CreateOverride(callInfo, files);
            return callInfo;
        }
