...
namespace Llprk.Web.UI.Areas.Admin.Controllers
{
    ...
    public partial class T4MVC_AccountController : Llprk.Web.UI.Areas.Admin.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Llprk.Web.UI.Areas.Store.Models.LoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(Llprk.Web.UI.Areas.Store.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
